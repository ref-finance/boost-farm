...
pub use boost_farming::{
    E000_ALREADY_INIT, E001_PROMISE_RESULT_COUNT_INVALID, E002_NOT_ALLOWED, E003_NOT_INIT, E004_CONTRACT_PAUSED, E005_NOT_ALLOWED_ON_CUR_STATE, 
    E100_ACC_NOT_REGISTERED, E101_INSUFFICIENT_BALANCE, E102_INSUFFICIENT_STORAGE, E103_STILL_HAS_REWARD, E104_STILL_HAS_SEED,
    E200_INVALID_RATIO, E201_INVALID_DURATION, E202_FORBID_SELF_BOOST, E203_EXCEED_FARM_NUM_IN_BOOST, E204_EXCEED_SEED_NUM_IN_BOOSTER,
...
near_sdk_sim::lazy_static_include::lazy_static_include_bytes! {
    PREV_BOOST_FARMING_WASM_BYTES => "../../res/boost_farming.wasm",
...
impl Env {
    pub fn init_with_contract(contract_bytes: &[u8]) -> Self {
        ...
        owner.function_call(
            farming_contract.contract.resume_contract(),
            MAX_GAS.0,
            1,
        );
